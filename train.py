...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str, default='options/train/train_fivek.yml', help='Path to option YAML file.')
    parser.add_argument(
        '--launcher',
...
def main():
    ...
    x = torch.randn(1, 3, 480, 720).to(device)
    
    summary(model.net_g, input_data=(x), col_names=["input_size", "output_size", "num_params", "mult_adds"])
    # training
    logger.info(
